...
const initPayment = (bookingId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!payment) {
        throw new appError_1.default(axios_1.HttpStatusCode.NotFound, "Payment Not found. You have not booked this tour");
    }
    ...
    const sslPayment = yield sslCommerz_service_1.SSLServiece.sslPaymentInit(sslPayload);
    return {
...
const successPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const pdfBuffer = yield (0, invoice_1.generatePdf)(invoieData);
        const cloudinaryResult = yield (0, cloudinary_config_1.uploadBufferCloudinary)(pdfBuffer, "invoice");
...
const failPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const updatedPayment = yield payment_model_1.Payment.findOneAndUpdate({ transactionId: query.transactionId }, {
            status: payment_interface_1.PAYMENT_STATUS.FAIL,
        }, { session });
