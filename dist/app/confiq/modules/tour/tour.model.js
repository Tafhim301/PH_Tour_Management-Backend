...
tourSchema.pre("save", function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (this.isModified("title")) {
            const baseSlug = (_a = this.title) === null || _a === void 0 ? void 0 : _a.toLocaleLowerCase().split(" ").join("-");
            let slug = `${baseSlug}`;
            let counter = 0;
...
tourSchema.pre("findOneAndUpdate", function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (tour.title) {
            const baseSlug = (_a = tour.title) === null || _a === void 0 ? void 0 : _a.toLocaleLowerCase().split(" ").join("-");
            let slug = `${baseSlug}`;
            let counter = 0;
            while (yield exports.Tour.exists({ slug })) {
                slug = `${slug}-${counter++}`;
