...
const createUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield user_model_1.User.create(Object.assign({ email, auths: [authProvider], password: hashedPassword }, rest));
    return user;
});
...
const getSingleUser = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const user = user_model_1.User.findById(id).select("-password");
    return user;
});
